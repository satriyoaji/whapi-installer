...
class Datastore extends EventEmitter {
  ...
  async _insertAsync (newDoc) {
    ...
    this.emit('operations.done', { type: 'insert' })
   ...
   */
  countAsync (query) {
    this.emit('operations.done', { type: 'count' })
  ...
  findAsync (query, projection = {}) {
    ...
    this.emit('operations.done', { type: 'find' })
    return cursor
  }
  ...
  findOneAsync (query, projection = {}) {
    ...
    this.emit('operations.done', { type: 'findOne' })
    return cursor
  }
  ...
  async _updateAsync (query, update, options) {
    ...
    this.emit('operations.done', { type: 'update' })
  ...
  async _removeAsync (query, options = {}) {
    ...
    this.emit('operations.done', { type: 'remove' })
    return numRemoved
  }
